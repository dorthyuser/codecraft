...
import I from './Icons';
import { FILE_TREE } from '../data/index';
...
export function CodeViewer({ sample, onLensClick }) {
  return (
...
export function FileTree({ projectName }) {
  return (
...
export function ModalShell({ children, onClose, sizeClass = '', noBackdropClose }) {
  useEffect(() => {
